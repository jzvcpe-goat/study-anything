...
Study Anything v0.3.29-alpha adds `published-image-evidence-v1` so an external
...
- `docker manifest inspect ghcr.io/jzvcpe-goat/study-anything/api:v0.3.29-alpha` shows `linux/amd64` and `linux/arm64`.
