...
Patch Proposal Customer Feedback Controlled Follow-up Feedback Rehearsal sits after
...
- consume only `patch-proposal-controlled-follow-up-feedback-envelope-refs-v1`;
...
- emit only `patch-proposal-controlled-follow-up-feedback-rehearsal-receipt-v1`;
...
- `fixtures/patch-proposal-customer-feedback-controlled-follow-up-feedback-boundary-gate/*/patch-proposal-controlled-follow-up-feedback-envelope-refs.json`
- `platform/generated/study-anything-patch-proposal-customer-feedback-controlled-follow-up-feedback-boundary-gate.json`

It emits:

- `fixtures/patch-proposal-customer-feedback-controlled-follow-up-feedback-rehearsal/*/patch-proposal-controlled-follow-up-feedback-rehearsal-receipt.json`
...
```bash
python3 scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_rehearsal.py --check
```

Regenerate:

```bash
python3 scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_rehearsal.py --write
```

## Chinese Summary

Patch Proposal Customer Feedback Controlled Follow-up Feedback Rehearsal 是
