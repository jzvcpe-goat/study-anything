...
- [ ] Verify the GitHub prerelease attaches `study-anything-codex-plugin-pack.json`, `study-anything-codex-plugin-pack.zip`, `study-anything-codex-plugin-pack.sha256`, `study-anything-kimi-plugin-pack.json`, `study-anything-kimi-plugin-pack.zip`, `study-anything-kimi-plugin-pack.sha256`, `study-anything-workbuddy-plugin-pack.json`, `study-anything-workbuddy-plugin-pack.zip`, `study-anything-workbuddy-plugin-pack.sha256`, `study-anything-hermes-plugin-pack.json`, `study-anything-hermes-plugin-pack.zip`, and `study-anything-hermes-plugin-pack.sha256`.
