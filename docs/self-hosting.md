...
```bash
STUDY_ANYTHING_IMAGE_TAG=v0.2.3-alpha USE_PUBLISHED_IMAGES=true ./scripts/launch_self_host.sh

STUDY_ANYTHING_API_IMAGE=registry.example/study-anything/api:v0.2.3-alpha \
STUDY_ANYTHING_WEB_IMAGE=registry.example/study-anything/web:v0.2.3-alpha \
USE_PUBLISHED_IMAGES=true ./scripts/launch_self_host.sh
```
