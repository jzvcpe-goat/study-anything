...
```bash
STUDY_ANYTHING_IMAGE_TAG=v0.3.18-alpha USE_PUBLISHED_IMAGES=true ./scripts/launch_self_host.sh

STUDY_ANYTHING_API_IMAGE=registry.example/study-anything/api:v0.3.18-alpha \
USE_PUBLISHED_IMAGES=true ./scripts/launch_self_host.sh
```
