...
class PlatformBundleManifestTests(unittest.TestCase):
    ...
    def test_platform_bundle_manifest_points_to_expected_assets(self) -> None:
        ...
        self.assertIn("scripts/delivery_trust_receipt.py", file_paths)
        self.assertIn("scripts/verify_delivery_trust_receipt.py", file_paths)
        self.assertIn("scripts/customer_handoff_package.py", file_paths)
        self.assertIn("scripts/verify_customer_handoff_package.py", file_paths)
        self.assertIn("docs/trust-model.md", file_paths)
        self.assertIn("docs/delivery-trust-receipt.md", file_paths)
        self.assertIn("docs/customer-handoff-package.md", file_paths)
        self.assertIn("platform/schemas/delivery-trust/delivery-trust-receipt-v1.schema.json", file_paths)
        self.assertIn("platform/schemas/customer-handoff/customer-handoff-package-v1.schema.json", file_paths)
        self.assertIn("platform/generated/study-anything-delivery-trust-receipt.json", file_paths)
        self.assertIn("platform/generated/study-anything-delivery-trust-receipt.html", file_paths)
        self.assertIn("platform/generated/study-anything-customer-handoff-package.json", file_paths)
        self.assertIn("platform/generated/study-anything-customer-handoff-package.html", file_paths)
        self.assertIn("platform/generated/study-anything-customer-handoff-package.zip", file_paths)
        self.assertIn("fixtures/delivery-trust/pass/delivery-trust-receipt.json", file_paths)
        self.assertIn("fixtures/customer-handoff/pass/customer-handoff-package.json", file_paths)
