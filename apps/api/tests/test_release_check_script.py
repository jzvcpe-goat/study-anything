...
class ReleaseCheckScriptTests(unittest.TestCase):
    def test_release_check_declares_phases_and_pip_bounds(self) -> None:
        ...
        self.assertIn("verify_cbb_v1_scenarios.py --check", script)
        self.assertIn("verify_cbb_v1_qualification.py --check", script)
        self.assertIn("verify_cbb_v1_outcomes.py --check", script)
        ...
        self.assertIn("verify_personal_local_release.py --check", script)
    ...
    def test_dual_loop_only_mode_writes_partial_receipt(self) -> None:
        ...
        self.assertTrue(receipt["cbb_v1_scenario_verifiers_integrated"])
        self.assertFalse(receipt["cbb_v1_scenario_verifiers_passed_individually"])
        self.assertTrue(receipt["cbb_v1_qualification_verifiers_integrated"])
        self.assertFalse(receipt["cbb_v1_qualification_verifiers_passed_individually"])
        self.assertTrue(receipt["cbb_v1_outcome_verifiers_integrated"])
        ...
        self.assertTrue(receipt["personal_local_release_verifier_integrated"])
        self.assertFalse(receipt["personal_local_release_verifier_passed"])
