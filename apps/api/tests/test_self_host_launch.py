...
class SelfHostLaunchTests(unittest.TestCase):
    ...
    def test_published_launch_pulls_images_sequentially_without_building(self) -> None:
        ...
        api_pull = (
            "docker pull "
            "ghcr.io/jzvcpe-goat/study-anything/api:v0.2.11-alpha"
        )
...
class PublishedImageLaunchTests(unittest.TestCase):
    def test_default_expected_version_normalizes_alpha_tag(self) -> None:
        ...
        self.assertEqual(module.default_expected_version("v0.2.11-alpha"), "0.2.11a0")
        self.assertEqual(module.default_expected_version("0.2.11-alpha"), "0.2.11a0")
