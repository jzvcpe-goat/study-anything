...
Planned surface: full Mastra runtime, project watchers, DecisionCard/Risk/Human Mastery Gate core, generic HTML Artifact console, personal plugins. Current bridge: a copy-ready Mastra adapter contract pack for external Mastra projects.

当前已交付表面：Study Anything API、Skill Mode、平台 Agent 包、Docker 自托管、学习/eval/导出闭环。

计划中表面：完整 Mastra runtime、项目 watcher、DecisionCard/Risk/Human Mastery Gate core、通用 HTML Artifact console、个人插件。当前桥接能力：一个可复制到外部 Mastra 项目的 Mastra adapter contract pack。
