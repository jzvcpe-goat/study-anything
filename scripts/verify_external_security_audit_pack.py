...
EXPECTED_CBB_V1_PACK_ASSETS = {
    ...
    "fixtures/cbb-external-adoption-attestation/attestation-ready.json",
    "fixtures/cbb-external-adoption-attestation/synthetic-valid.json",
    "fixtures/cbb-external-adoption-attestation/wrong-commit.json",
    "fixtures/cbb-external-adoption-attestation/wrong-case-digest.json",
    "fixtures/cbb-external-adoption-attestation/self-certified.json",
    "fixtures/cbb-external-adoption-attestation/untrusted-external.json",
    "fixtures/cbb-external-adoption-attestation/invalid-signature.json",
    ...
    "apps/api/study_anything/cbb/adoption/attestation_models.py",
    "apps/api/study_anything/cbb/adoption/attestation_intake.py",
    "apps/api/study_anything/cbb/adoption/attestation_fixtures.py",
    ...
    "scripts/cbb_external_adoption_attestation.py",
...
EXPECTED_CBB_V1_PLAN_ASSETS = EXPECTED_CBB_V1_PACK_ASSETS | {
    ...
    "docs/quality-audits/phase-40-external-adoption-attestation.md",
}
