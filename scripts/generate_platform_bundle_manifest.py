...
FILES: list[tuple[str, str, str]] = [
    ...
    (
        ...
        "generated_asset",
        "Controlled adoption outcome and non-expanding scope verification report.",
    ),
    (
        "platform/generated/study-anything-cbb-external-adoption-attestation.json",
        "generated_asset",
        "External-adopter signature, trust-root, and case-binding verification report.",
    ),
    (
        "platform/generated/study-anything-cbb-external-audit-intake.json",
        "generated_asset",
        "Signed external-audit intake and closure-boundary verification report.",
    ),
    (
    ...
    (
        ...
        "operator_doc",
        "Controlled shadow, dogfood, canary, incident, rollback, revocation, and reopen guide.",
    ),
    (
        "docs/cbb-external-adoption-attestation.md",
        "operator_doc",
        "Independently pinned external-adopter signature and case-binding guide.",
    ),
    (
        "docs/cbb-external-audit-intake.md",
        "operator_doc",
        "Signed external audit intake, identity, remediation, and closure state guide.",
    ),
    (
    ...
    (
        ...
        "schema",
        "Signed external security audit intake envelope JSON Schema.",
    ),
    (
        "platform/schemas/security/external-security-audit-intake-receipt-v1.schema.json",
        "schema",
        "External security audit intake state receipt JSON Schema.",
    ),
    (
    ...
    (
        ...
        "schema",
        "Controlled adoption case and exact-release binding JSON Schema.",
    ),
    (
        "platform/schemas/cbb/cbb.controlled-adoption-receipt.v1.schema.json",
        "schema",
        "Controlled adoption outcome and non-expanding authority JSON Schema.",
    ),
    (
        "platform/schemas/cbb/cbb.external-adoption-attestation-envelope.v1.schema.json",
        "schema",
        "External-adopter signed observation and identity envelope JSON Schema.",
    ),
    (
        "platform/schemas/cbb/cbb.external-adoption-attestation-receipt.v1.schema.json",
        "schema",
        "External-adopter trust-root and case-binding receipt JSON Schema.",
    ),
    (
    ...
    *[
    ...
    (
        ...
        "fixture",
        "Redacted release stack intake candidate fixture for PR 396.",
    ),
    (
        "fixtures/release-stack/pr-398-intake-candidate.json",
        "fixture",
        "Redacted release stack intake candidate fixture for PR 398.",
    ),
    (
        "fixtures/release-stack/pr-401-intake-candidate.json",
        "fixture",
        "Redacted release stack intake candidate fixture for PR 401.",
    ),
    (
