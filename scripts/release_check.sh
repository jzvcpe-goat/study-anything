...
cbb_v1_outcome_verifiers_integrated="true"
cbb_v1_outcome_verifiers_passed_individually="false"
cbb_v1_agentic_verifiers_integrated="true"
cbb_v1_agentic_verifiers_passed_individually="false"
cbb_v1_conformance_verifiers_integrated="true"
cbb_v1_conformance_verifiers_passed_individually="false"
cbb_v1_adoption_audit_verifiers_integrated="true"
...
payload = {
    ...
    "cbb_v1_outcome_verifiers_integrated": $(json_bool "$cbb_v1_outcome_verifiers_integrated"),
    "cbb_v1_outcome_verifiers_passed_individually": $(json_bool "$cbb_v1_outcome_verifiers_passed_individually"),
    "cbb_v1_agentic_verifiers_integrated": $(json_bool "$cbb_v1_agentic_verifiers_integrated"),
    "cbb_v1_agentic_verifiers_passed_individually": $(json_bool "$cbb_v1_agentic_verifiers_passed_individually"),
    "cbb_v1_conformance_verifiers_integrated": $(json_bool "$cbb_v1_conformance_verifiers_integrated"),
    "cbb_v1_conformance_verifiers_passed_individually": $(json_bool "$cbb_v1_conformance_verifiers_passed_individually"),
    "cbb_v1_adoption_audit_verifiers_integrated": $(json_bool "$cbb_v1_adoption_audit_verifiers_integrated"),
...
run_cbb_protocol_verifier_gates() {
  ...
  if [ "$dependency_backed_contracts" = "required" ]; then
    ...
    "$python_bin" scripts/generate_cbb_v1_outcome_assets.py --check
    "$python_bin" scripts/verify_cbb_v1_outcomes.py --check
    "$python_bin" scripts/generate_cbb_v1_agentic_assets.py --check
    "$python_bin" scripts/verify_cbb_agentic_tool_boundary.py --check
    "$python_bin" scripts/verify_cbb_memory_quarantine.py --check
    "$python_bin" scripts/verify_cbb_evolution_gate.py --check
    "$python_bin" scripts/generate_cbb_v1_conformance_pack.py --check
    "$python_bin" scripts/verify_cbb_v1_external_consumer.py --check
    "$python_bin" scripts/generate_cbb_adoption_audit_assets.py --check
    ...
    cbb_v1_outcome_verifiers_passed_individually="true"
    cbb_v1_agentic_verifiers_passed_individually="true"
    cbb_v1_conformance_verifiers_passed_individually="true"
    cbb_v1_adoption_audit_verifiers_passed_individually="true"
  else
    printf "skip  CBB v1 contract, kernel, provenance, scenario, qualification, outcome, Agentic evolution, conformance, adoption, and audit-intake verifiers require project dependencies; dual-loop-only does not claim they passed.\n"
  fi
...
"$python_bin" scripts/generate_external_security_audit_pack.py --check
"$python_bin" scripts/verify_external_security_audit_pack.py --check
...
"$python_bin" scripts/verify_strict_reliability_acceptance.py --check
...
"$python_bin" scripts/verify_patch_proposal_customer_feedback_delivery_trust_case_bridge.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_boundary_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_rehearsal.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_outcome_receipt.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_intake.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_backlog_bridge.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_product_owner_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_spec_eval_authoring_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_product_loop_brief_intake_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_delivery_trust_intake_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_delivery_trust_case_bridge.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_boundary_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_rehearsal.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_outcome.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_loop_closure.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_bridge.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_intake_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_backlog_bridge.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_product_owner_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_spec_eval_authoring_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_product_loop_brief_intake_gate.py --check
"$python_bin" scripts/verify_patch_proposal_customer_feedback_controlled_follow_up_feedback_reopen_intake_delivery_trust_intake_gate.py --check
"$python_bin" scripts/generate_dual_loop_trust_scenario_pack.py --check
"$python_bin" scripts/verify_dual_loop_trust_scenario_pack.py --check
"$python_bin" scripts/verify_dual_loop_trust_pack_consumer_walkthrough.py --check
