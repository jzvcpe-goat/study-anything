...
PACK_FILES: list[tuple[str, str, str]] = [
    ...
    ("docs/platform-plugin-downloads.md", "operator_doc", "GitHub Release download guide for Codex, Kimi, and WorkBuddy plugin packs."),
    ...
    ("scripts/generate_platform_plugin_packs.py", "verification", "Generate downloadable Codex, Kimi, and WorkBuddy platform plugin packs."),
