...
PACK_FILES: list[tuple[str, str, str]] = [
    ...
    ("platform/generated/study-anything-cognitive-loop-pr-ci-receipt.json", "submission_report", "Cognitive Loop PR CI metadata-only receipt verification report."),
    ...
    ("platform/generated/study-anything-cognitive-loop-recipe-cli-schemas.json", "submission_report", "Offline JSON Schemas for Cognitive Loop recipe CLI success, receipt, and failure reports."),
    ...
    ("scripts/verify_cognitive_loop_pr_ci_receipt.py", "verification", "Verify PR CI receipt decisions, required checks, and privacy boundaries."),
