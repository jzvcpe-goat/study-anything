...
PACK_FILES: list[tuple[str, str, str]] = [
    ...
    ("docs/cbb-protocol-v1-outcomes.md", "operator_doc", "Post-delivery outcome receipt and non-increasing trust-degradation guide."),
    ("docs/cbb-protocol-v1-agentic-evolution.md", "operator_doc", "Typed Agentic tools, quarantined memory, and proposal-only evolution-gate guide."),
    ("docs/cbb-protocol-v1-conformance.md", "operator_doc", "Protocol v1 offline fixture-conformance and second-consumer guide."),
    ("docs/cbb-controlled-adoption.md", "operator_doc", "Controlled shadow, dogfood, canary, incident, rollback, revocation, and reopen guide."),
    ("docs/cbb-external-adoption-attestation.md", "operator_doc", "Independently pinned external-adopter signature and case-binding guide."),
    ("docs/cbb-external-audit-intake.md", "operator_doc", "Signed external audit intake, identity, remediation, and closure state guide."),
    ("docs/protocol-governance.md", "operator_doc", "Open protocol change, review, and security-disclosure governance."),
    ("docs/extensions-and-versioning.md", "operator_doc", "Fail-closed extension authority and version-negotiation rules."),
    ("docs/compatibility-and-trademark.md", "operator_doc", "Neutral compatibility language and non-certification boundary."),
    ...
    ("platform/schemas/cbb/cbb.delivery-outcome-receipt.v1.schema.json", "schema", "Canonical CBB Protocol v1 post-delivery outcome JSON Schema."),
    ("platform/schemas/cbb/cbb.evolution-gate-receipt.v1.schema.json", "schema", "Canonical CBB Protocol v1 proposal-only evolution-gate JSON Schema."),
    ("platform/schemas/cbb/cbb.controlled-adoption-case.v1.schema.json", "schema", "Controlled adoption case and exact-release binding JSON Schema."),
    ("platform/schemas/cbb/cbb.controlled-adoption-receipt.v1.schema.json", "schema", "Controlled adoption outcome and non-expanding authority JSON Schema."),
    ("platform/schemas/cbb/cbb.external-adoption-attestation-envelope.v1.schema.json", "schema", "External-adopter signed observation and identity envelope JSON Schema."),
    ("platform/schemas/cbb/cbb.external-adoption-attestation-receipt.v1.schema.json", "schema", "External-adopter trust-root and case-binding receipt JSON Schema."),
    ("platform/schemas/security/external-security-audit-intake-envelope-v1.schema.json", "schema", "Signed external security audit intake envelope JSON Schema."),
    ("platform/schemas/security/external-security-audit-intake-receipt-v1.schema.json", "schema", "External security audit intake state receipt JSON Schema."),
    ...
    ("platform/generated/study-anything-cbb-v1-outcomes.json", "submission_report", "Post-delivery outcome and trust-degradation verification report."),
    ("platform/generated/study-anything-cbb-agentic-tool-boundary.json", "submission_report", "Typed allowlisted Agentic tool boundary report."),
    ("platform/generated/study-anything-cbb-memory-quarantine.json", "submission_report", "Quarantined memory provenance, expiry, injection, and counter-evidence report."),
    ("platform/generated/study-anything-cbb-evolution-gate.json", "submission_report", "Proposal-only deterministic evolution-gate report."),
    ("platform/generated/study-anything-cbb-v1-conformance-pack.json", "submission_report", "Deterministic Protocol v1 conformance pack manifest."),
    ("platform/generated/study-anything-cbb-v1-conformance-pack.md", "submission_report", "Human-readable Protocol v1 conformance pack summary."),
    ("platform/generated/study-anything-cbb-v1-conformance-pack.zip", "submission_report", "Portable offline Protocol v1 conformance pack archive."),
    ("platform/generated/study-anything-cbb-v1-conformance-pack.sha256", "submission_report", "Protocol v1 conformance archive checksum."),
    ("platform/generated/study-anything-cbb-v1-external-consumer.json", "submission_report", "Package-independent Protocol v1 consumer verification report."),
    ("platform/generated/study-anything-cbb-controlled-adoption-outcomes.json", "submission_report", "Controlled adoption outcome and non-expanding scope verification report."),
    ("platform/generated/study-anything-cbb-external-adoption-attestation.json", "submission_report", "External-adopter signature, trust-root, and case-binding verification report."),
    ("platform/generated/study-anything-cbb-external-audit-intake.json", "submission_report", "Signed external-audit intake and closure-boundary verification report."),
    ...
    *[
    ...
    ("fixtures/cbb-controlled-adoption/shadow-pass.json", "fixture", "Synthetic shadow observation without new authority."),
    ("fixtures/cbb-controlled-adoption/dogfood-pass.json", "fixture", "Synthetic local dogfood observation without customer authority."),
    ("fixtures/cbb-controlled-adoption/canary-scope-expansion-blocked.json", "fixture", "Canary scope-expansion rejection."),
    ("fixtures/cbb-controlled-adoption/incident-freezes.json", "fixture", "Incident freezes source clearance."),
    ("fixtures/cbb-controlled-adoption/rollback-narrows.json", "fixture", "Rollback narrows allowed scope."),
    ("fixtures/cbb-controlled-adoption/claim-violation-revokes.json", "fixture", "Claim violation revokes source clearance."),
    ("fixtures/cbb-controlled-adoption/reopen-requires-fresh-clearance.json", "fixture", "Reopen requires a fresh clearance."),
    ("fixtures/cbb-external-adoption-attestation/attestation-ready.json", "fixture", "Pinned scope awaiting an external adopter signature."),
    ("fixtures/cbb-external-adoption-attestation/synthetic-valid.json", "fixture", "Synthetic signature validation without external identity."),
    ("fixtures/cbb-external-adoption-attestation/wrong-commit.json", "fixture", "Wrong release-commit attestation rejection."),
    ("fixtures/cbb-external-adoption-attestation/wrong-case-digest.json", "fixture", "Wrong controlled-adoption case digest rejection."),
    ("fixtures/cbb-external-adoption-attestation/self-certified.json", "fixture", "Repository self-attestation rejection."),
    ("fixtures/cbb-external-adoption-attestation/untrusted-external.json", "fixture", "Unpinned external signer rejection."),
    ("fixtures/cbb-external-adoption-attestation/invalid-signature.json", "fixture", "Invalid external-adopter signature rejection."),
    ("fixtures/cbb-external-audit-intake/audit-ready.json", "fixture", "Audit-ready state without a received report."),
    ("fixtures/cbb-external-audit-intake/synthetic-valid.json", "fixture", "Synthetic signature validation without external identity."),
    ("fixtures/cbb-external-audit-intake/wrong-commit.json", "fixture", "Wrong audit commit binding rejection."),
    ("fixtures/cbb-external-audit-intake/incomplete-scope.json", "fixture", "Incomplete audit scope rejection."),
    ("fixtures/cbb-external-audit-intake/self-certified.json", "fixture", "Repository self-certification rejection."),
    ("fixtures/cbb-external-audit-intake/open-high.json", "fixture", "Open high finding keeps remediation pending."),
    ("fixtures/cbb-external-audit-intake/invalid-signature.json", "fixture", "Invalid detached signature rejection."),
    ...
    ("scripts/generate_cbb_adoption_audit_assets.py", "generator", "Generate controlled-adoption, external-attestation, and audit-intake schemas and fixtures."),
    ("scripts/cbb_controlled_adoption.py", "cli", "Build controlled adoption receipts from bounded local case metadata."),
    ("scripts/cbb_external_adoption_attestation.py", "cli", "Evaluate ready and signed external-adopter attestation envelopes."),
    ("scripts/cbb_external_audit_intake.py", "cli", "Evaluate audit-ready and signed external report intake envelopes."),
    ("scripts/verify_cbb_controlled_adoption_outcomes.py", "verification", "Verify controlled adoption outcomes and no scope expansion."),
    ("scripts/verify_cbb_external_adoption_attestation.py", "verification", "Verify external-adopter signatures, trust roots, case binding, and zero synthetic evidence."),
    ("scripts/verify_cbb_external_audit_intake.py", "verification", "Verify signed audit intake, identity separation, remediation, and closure boundaries."),
