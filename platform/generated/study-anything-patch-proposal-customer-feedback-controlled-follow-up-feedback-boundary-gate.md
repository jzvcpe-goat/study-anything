...
- `blocked-automatic-customer-send`: `blocked` / `block_controlled_follow_up_boundary` / refs: `False` / reasons: automatic_customer_send_rejected
- `blocked-customer-visible-follow-up`: `blocked` / `block_controlled_follow_up_boundary` / refs: `False` / reasons: customer_visible_follow_up_rejected
...
- `blocked-model-call`: `blocked` / `block_controlled_follow_up_boundary` / refs: `False` / reasons: model_call_rejected
