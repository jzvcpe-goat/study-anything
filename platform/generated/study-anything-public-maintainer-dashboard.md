...
- `published_image_blocker` -> `published_image_pull_failure`: `python3 scripts/verify_published_image_launch.py --tag v0.3.21-alpha --pull-timeout-seconds 180 --allow-pull-timeout-report`
